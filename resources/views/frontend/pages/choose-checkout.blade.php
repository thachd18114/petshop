...
@section('main-content')
        ...
        <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50 "  ng-controller="DonHangController">
            <form name="orderForm" id="orderForm"   novalidate>
                <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                    <div class="container">
                        ...
                        <div class="form-group">
                            ...
                            <span class="error" ng-show="orderForm.dh_nguoiNhan.$error.required">Vui lòng nhập tên người nhận!</span>
                        </div>
                        <div class="form-group">
                            ...
                            <span class="error" ng-show="orderForm.dh_diaChi.$error.required">Vui lòng nhập địa chỉ!</span>
                        </div>
                        <div class="form-group">
                            ...
                            <span class="error" ng-show="orderForm.dh_dienThoai.$error.required">Vui lòng nhập điện thoại!</span>
                        </div>
                        <div class="form-group" style="padding-bottom: 5px">
                            <label for="tt_ma">Phương thức thanh toán:</label>
                            <select name="httt_id" id="httt_id" class="form-control" ng-model="httt_id" >
                            @foreach($hinhthucthanhtoan as $tt)
                                    <option value="{{ $tt->httt_id }}">{{ $tt->httt_ten }}</option>
                                @endforeach
                            </select>
                            <span class="error " ng-show="loi == true">Bạn chưa chọn hình thức thanh toán!</span>

                        </div>
                        <button type="submit" ng-click="modal()"  ng-disabled="orderForm.$invalid" class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer mb-4" id="modalcheckout"  ng-disabled="orderForm.$invalid && ngCart.getTotalItems() === 0">
                            Thanh toán
                        </button>
                    </div>

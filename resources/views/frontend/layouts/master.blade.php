    ...
    <div class="container">
        ...
        <div class="row isotope-grid">
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="{{ asset('themes/cozastore/images/product-01.jpg') }}" alt="IMG-PRODUCT">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="{{ asset('themes/cozastore/images/product-02.jpg') }}" alt="IMG-PRODUCT">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="{{ asset('themes/cozastore/images/product-03.jpg') }}" alt="IMG-PRODUCT">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="{{ asset('themes/cozastore/images/product-04.jpg') }}" alt="IMG-PRODUCT">

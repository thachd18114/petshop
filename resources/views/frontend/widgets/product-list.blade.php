                            ...
                            <div class="block2-txt-child1 flex-col-l ">
                                ...
                                <span class=" cl3" style="color: #e10c00; font-size: large">
                                    @if($sp->giatri != null && strtotime($sp->km_ngayBatDau) <= strtotime($date) && strtotime($sp->km_ngayKetThuc) >= strtotime($date) )
                                        <del style="color: #878787;">{{ number_format($sp->tc_giaBan) }} <u>đ</u></del> <span style="padding-left: 5px;font-weight: bold">{{ number_format($sp->tc_giaBan* (100-$sp->giatri)/100) }} <u>đ</u></span>
